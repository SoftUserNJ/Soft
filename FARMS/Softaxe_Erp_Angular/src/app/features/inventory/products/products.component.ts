...
export class ProductsComponent {
  ...
  onClickSave() {
    ...
    const test = this.L4Code;
    const test1 = this.level4;
    ...
    body.code = body.code ?? '';
    body.saleCode = this.level4.find((x) => x.stockCode == this.L4Code).saleCode;
    body.stockCode = this.L4Code;
    body.noStock = body.noStock ?? false;
    body.hsNo = body.hsNo ?? '';
