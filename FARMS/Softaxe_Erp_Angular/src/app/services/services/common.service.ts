...
import { SalesComponent } from '../features/purchase/sales-new/sales.component';
...
export class CommonService {
  ...
  viewSaleInvoice(url: any, date: any) {
    
    const modalConfig: ModalOptions = {
      class: 'sale-inv-modal',
      initialState: {
        invNo: url,
        invDate: date,
      },
    ...
    this.modalRef = this.modalService.show(SalesComponent, modalConfig);
  }
