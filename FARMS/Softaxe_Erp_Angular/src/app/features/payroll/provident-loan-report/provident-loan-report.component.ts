...
@Component({
  selector: 'app-provident-loan-report',
  templateUrl: './provident-loan-report.component.html',
  styleUrls: ['./provident-loan-report.component.css']
})
export class ProvidentLoanReportComponent {
  ...
  openReportModal() {
    ...
    let url = `ProvidentLoanReport?Fdate=${FDate}&Tdate=${TDate}`;
    ...
    url += form.DesignationId != null && form.DesignationId !== undefined ? `&designationId=${form.DesignationId}` : '&designationId=%';
