...
public partial class CityTechDevContext : DbContext
{
    public CityTechDevContext()
    {
    }
    private readonly IConfiguration Configuration;
    public CityTechDevContext(DbContextOptions<CityTechDevContext> options, IConfiguration configuration)
        : base(options)
    {
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            string connectionString = Configuration.GetConnectionString("CityTechConStr");
