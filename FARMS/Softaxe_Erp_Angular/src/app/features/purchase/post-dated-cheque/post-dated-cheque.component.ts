...
export class PostDatedChequeComponent {
  ...
  getPDBank() {
    this.apiService.getData('Purchase/GetPDBank').subscribe((data) => {
      this.pdBank = data;
    });
  }

  getPDParty() {
    this.apiService.getData('Purchase/GetPDParty').subscribe((data) => {
      this.pdParty = data;
    });
  }
  ...
  getPDChequeList() {
    try {
      ...
      this.apiService
        .getDataById('Purchase/GetPDChequeList', obj)
        .subscribe((data) => {
  ...
  savePDCheque() {
    try {
      ...
      this.apiService
        .saveData('Purchase/SavePDCheque', pdCheque)
        .subscribe((result) => {
          if (result == true || result == 'true') {
            this.toastr.success('Save Successfully');
            this.getPDChequeList();
