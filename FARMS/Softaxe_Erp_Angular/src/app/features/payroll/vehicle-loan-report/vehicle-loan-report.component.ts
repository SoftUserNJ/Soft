...
@Component({
  selector: 'app-vehicle-loan-report',
  templateUrl: './vehicle-loan-report.component.html',
  styleUrls: ['./vehicle-loan-report.component.css']
})
export class VehicleLoanReportComponent {
  ...
  openReportModal() {
    ...
    let url = `VehLoanReport?Fdate=${FDate}&Tdate=${TDate}`;
