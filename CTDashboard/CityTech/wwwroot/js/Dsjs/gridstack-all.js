/*! For license information please see gridstack-all.js.LICENSE.txt */ ! function (e, t) {
    ...
    class i {
        ...
        static createStylesheet(e, t, i) {
            ...
            const o = i?.nonce;
            return o && (s.nonce = o), s.setAttribute("type", "text/css"), s.setAttribute("gs-style-id", e), s.styleSheet ? s.styleSheet.cssText = "" : s.appendChild(document.createTextNode("")), t ? t.insertBefore(s, t.firstChild) : (t = document.getElementsByTagName("head")[0]).appendChild(s), s.sheet
        }
        ...
        static copyPos(e, t, i = !1) {
            return void 0 !== t.x && (e.x = t.x), void 0 !== t.y && (e.y = t.y), void 0 !== t.w && (e.w = t.w), void 0 !== t.h && (e.h = t.h), i && (t.minW && (e.minW = t.minW), t.minH && (e.minH = t.minH), t.maxW && (e.maxW = t.maxW), t.maxH && (e.maxH = t.maxH)), e
        }
        static samePos(e, t) {
        ...
        static updateScrollPosition(e, t, i) {
            ...
            if (s.top < 0 || s.bottom > o) {
                ...
                if (null !== l) {
                    let h = l.scrollTop;
                    s.top < 0 && i < 0 ? e.offsetHeight > o ? l.scrollTop += i : l.scrollTop += Math.abs(r) > Math.abs(i) ? i : r : i > 0 && (e.offsetHeight > o ? l.scrollTop += i : l.scrollTop += n > i ? i : n), t.top += l.scrollTop - h
                }
            }
        }
        ...
        static clone(e) {
            return null == e || "object" != typeof e ? e : e instanceof Array ? [...e] : {
                ...e
            }
        }
        static cloneDeep(e) {
        ...
        static initEvent(e, t) {
            ...
            return e.dataTransfer && (i.dataTransfer = e.dataTransfer), ["altKey", "ctrlKey", "metaKey", "shiftKey"].forEach((t => i[t] = e[t])), ["pageX", "pageY", "clientX", "clientY", "screenX", "screenY"].forEach((t => i[t] = e[t])), {
                ...i,
                ...s
            }
        }
    ...
    class s {
        ...
        batchUpdate(e = !0, t = !0) {
            return !!this.batchMode === e || (this.batchMode = e, e ? (this._prevFloat = this._float, this._float = !0, this.saveInitial()) : (this._float = this._prevFloat, delete this._prevFloat, t && this._packNodes(), this._notify())), this
        }
        ...
        _fixCollisions(e, t = e, s, o = {}) {
            ...
            for (; s = s || this.collide(e, n, o.skip);) {
                let n;
                if (s.locked || e._moving && !e._skipDown && t.y > e.y && !this.float && (!this.collide(s, {
                    ...s,
                    y: e.y
                }, e) || !this.collide(s, {
                    ...s,
                    y: t.y - s.h
                }, e)) ? (e._skipDown = e._skipDown || t.y > e.y, n = this.moveNode(e, {
                    ...t,
                    y: s.y + s.h,
                    ...l
                }), s.locked && n ? i.copyPos(t, e) : !s.locked && n && o.pack && (this._packNodes(), t.y = s.y + s.h, i.copyPos(e, t)), r = r || n) : n = this.moveNode(s, {
                    ...s,
                    y: t.y + t.h,
                    skip: e,
                    ...l
        ...
        collide(e, t = e, s) {
            const o = e._id,
                n = s?._id;
            return this.nodes.find((e => e._id !== o && e._id !== n && i.isIntercepted(e, t)))
        }
        collideAll(e, t = e, s) {
            const o = e._id,
                n = s?._id;
            return this.nodes.filter((e => e._id !== o && e._id !== n && i.isIntercepted(e, t)))
        }
        ...
        swap(e, t) {
            ...
            let o;
            if (e.w === t.w && e.h === t.h && (e.x === t.x || e.y === t.y) && (o = i.isTouching(e, t))) return s();
            if (!1 !== o) {
        ...
        compact(e = "compact", t = !0) {
            ...
            let o = this.nodes;
            return this.nodes = [], o.forEach(((t, i, s) => {
                let o;
                t.locked || (t.autoPosition = !0, "list" === e && i && (o = s[i - 1])), this.addNode(t, !1, o)
        ...
        prepareNode(e, t) {
            ...
            return i.defaults(e, o), e.autoPosition || delete e.autoPosition, e.noResize || delete e.noResize, e.noMove || delete e.noMove, i.sanitizeMinMax(e), "string" == typeof e.x && (e.x = Number(e.x)), "string" == typeof e.y && (e.y = Number(e.y)), "string" == typeof e.w && (e.w = Number(e.w)), "string" == typeof e.h && (e.h = Number(e.h)), isNaN(e.x) && (e.x = o.x, e.autoPosition = !0), isNaN(e.y) && (e.y = o.y, e.autoPosition = !0), isNaN(e.w) && (e.w = o.w), isNaN(e.h) && (e.h = o.h), this.nodeBoundFix(e, t)
        }
        nodeBoundFix(e, t) {
            let s = e._orig || i.copyPos({}, e);
            if (e.maxW && (e.w = Math.min(e.w, e.maxW)), e.maxH && (e.h = Math.min(e.h, e.maxH)), e.minW && e.minW <= this.column && (e.w = Math.max(e.w, e.minW)), e.minH && (e.h = Math.max(e.h, e.minH)), (1 === this.column || e.x + e.w > this.column) && this.column < 12 && !this._inColumnResize && e._id && -1 === this.findCacheLayout(e, 12)) {
                let t = {
                    ...e
                };
                t.autoPosition ? (delete t.x, delete t.y) : t.x = Math.min(11, t.x), t.w = Math.min(12, t.w), this.cacheOneLayout(t, 12)
            }
            return e.w > this.column ? e.w = this.column : e.w < 1 && (e.w = 1), this.maxRow && e.h > this.maxRow ? e.h = this.maxRow : e.h < 1 && (e.h = 1), e.x < 0 && (e.x = 0), e.y < 0 && (e.y = 0), e.x + e.w > this.column && (t ? e.w = this.column - e.x : e.x = this.column - e.w), this.maxRow && e.y + e.h > this.maxRow && (t ? e.h = this.maxRow - e.y : e.y = this.maxRow - e.h), i.samePos(e, s) || (e._dirty = !0), e
        }
        getDirtyNodes(e) {
            return e ? this.nodes.filter((e => e._dirty && !i.samePos(e, e._orig))) : this.nodes.filter((e => e._dirty))
        }
        _notify(e) {
        ...
        findEmptyPosition(e, t = this.nodes, s = this.column, o) {
            ...
            for (let r = o ? o.y * s + (o.x + o.w) : 0; !n; ++r) {
                ...
                t.find((e => i.isIntercepted(h, e))) || (e.x === o && e.y === l || (e._dirty = !0), e.x = o, e.y = l, delete e.autoPosition, n = !0)
            }
            return n
        }
        addNode(e, t = !1, i) {
            let s;
            return this.nodes.find((t => t._id === e._id)) || (delete (e = this._inColumnResize ? this.nodeBoundFix(e) : this.prepareNode(e))._temporaryRemoved, delete e._removeDOM, e.autoPosition && this.findEmptyPosition(e, this.nodes, this.column, i) && (delete e.autoPosition, s = !0), this.nodes.push(e), t && this.addedNodes.push(e), s || this._fixCollisions(e), this.batchMode || this._packNodes()._notify(), e)
        }
        removeNode(e, t = !0, i = !1) {
            return this.nodes.find((t => t._id === e._id)) ? (i && this.removedNodes.push(e), t && (e._removeDOM = !0), this.nodes = this.nodes.filter((t => t._id !== e._id)), this._packNodes()._notify([e])) : this
        }
        removeAll(e = !0) {
            return delete this._layouts, this.nodes.length ? (e && this.nodes.forEach((e => e._removeDOM = !0)), this.removedNodes = this.nodes, this.nodes = [], this._notify(this.removedNodes)) : this
        }
        moveNodeCheck(e, t) {
            ...
            let o, n = new s({
                column: this.column,
                float: this.float,
                nodes: this.nodes.map((t => t._id === e._id ? (o = {
                    ...t
                }, o) : {
                    ...t
                }))
        ...
        willItFit(e) {
            ...
            return this.cleanupNode(o), delete o.el, delete o._id, delete o.content, delete o.grid, t.addNode(o), t.getRow() <= this.maxRow && (e._willFitPos = i.copyPos({}, o), !0)
        }
        ...
        moveNode(e, t) {
            ...
            let o = e.w !== t.w || e.h !== t.h,
                n = i.copyPos({}, e, !0);
            if (i.copyPos(n, t), n = this.nodeBoundFix(n, o), i.copyPos(t, n), i.samePos(e, t)) return !1;
            let r = i.copyPos({}, e),
            ...
            if (l.length) {
                ...
                if (o && r && e.grid?.opts?.subGridDynamic && !e.grid._isTemp) {
                    let s = i.areaIntercept(t.rect, r._rect),
                        o = i.area(t.rect),
                        n = i.area(r._rect);
                    s / (o < n ? o : n) > .8 && (r.grid.makeSubGrid(r.el, void 0, e), r = void 0)
                }
                r ? h = !this._fixCollisions(e, n, r, t) : (h = !1, s && delete t.pack)
            }
            return h && (e._dirty = !0, i.copyPos(e, n)), t.pack && this._packNodes()._notify(), !i.samePos(e, r)
        }
        getRow() {
        ...
        save(e = !0, t) {
            let s = this._layouts?.length,
                ...
                n = [];
            return this.sortNodes(), this.nodes.forEach((s => {
                let r = o?.find((e => e._id === s._id)),
                    l = {
                        ...s
                    };
                r && (l.x = r.x, l.y = r.y, l.w = r.w), i.removeInternalForSave(l, !e), t && t(s, l), n.push(l)
            })), n
        }
        ...
        columnChanged(e, t, s, o = "moveScale") {
            ...
            n && this.sortNodes(1, e), t < e && this.cacheLayout(this.nodes, e), this.batchUpdate();
            let r = [],
                l = !1;
            if (1 === t && s?.length) {
                l = !0;
            ...
            if (t > e && this._layouts) {
                ...
                !i.length && e !== o && this._layouts[o]?.length && (e = o, this._layouts[o].forEach((e => {
                    ...
                    if (-1 !== t) {
                        ...
                        (e.autoPosition || isNaN(e.x) || isNaN(e.y)) && this.findEmptyPosition(e, r), e.autoPosition || (s[t].x = e.x, s[t].y = e.y, s[t].w = e.w, r.push(s[t])), s.splice(t, 1)
                    }
                }))
            }
            if (n) this.compact(o, !1);
                ...
                if (s.length)
                    if ("function" == typeof o) o(t, e, r, s);
                        ...
                        s.forEach((s => {
                            s.x = 1 === t ? 0 : l ? Math.round(s.x * i) : Math.min(s.x, t - 1), s.w = 1 === t || 1 === e ? 1 : h ? Math.round(s.w * i) || 1 : Math.min(s.w, t), r.push(s)
                        })), s = []
                    }
                l || (r = i.sort(r, -1, t)), this._inColumnResize = !0, this.nodes = [], r.forEach((e => {
                    this.addNode(e, !1), delete e._orig
                }))
            }
            return this.nodes.forEach((e => delete e._orig)), this.batchUpdate(!1, !n), delete this._inColumnResize, this
        }
        cacheLayout(e, t, i = !1) {
            let o = [];
            return e.forEach(((e, t) => {
                e._id = e._id ?? s._idSeq++, o[t] = {
                    x: e.x,
                    y: e.y,
                    w: e.w,
                    _id: e._id
                }
            })), this._layouts = i ? [] : this._layouts || [], this._layouts[t] = o, this
        }
        cacheOneLayout(e, t) {
            ...
            return -1 === o ? this._layouts[t].push(i) : this._layouts[t][o] = i, this
        }
        findCacheLayout(e, t) {
    ...
    class r { }
    const l = "undefined" != typeof window && "undefined" != typeof document && ("ontouchstart" in document || "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0);
    class h { }
    ...
    function u(e) {
        ...
        h.pointerLeaveTimeout && (window.clearTimeout(h.pointerLeaveTimeout), delete h.pointerLeaveTimeout);
    ...
    function _(e) {
        r.dragElement && (h.pointerLeaveTimeout = window.setTimeout((() => {
    ...
    class v {
        ...
        _init() {
            ...
            return e.classList.add("ui-resizable-handle"), e.classList.add(`${v.prefix}${this.dir}`), e.style.zIndex = "100", e.style.userSelect = "none", this.el = e, this.host.appendChild(this.el), this.el.addEventListener("mousedown", this._mouseDown), l && (this.el.addEventListener("touchstart", p), this.el.addEventListener("pointerdown", c)), this
        }
        destroy() {
            return this.moving && this._mouseUp(this.mouseDownEvent), this.el.removeEventListener("mousedown", this._mouseDown), l && (this.el.removeEventListener("touchstart", p), this.el.removeEventListener("pointerdown", c)), this.host.removeChild(this.el), delete this.el, delete this.host, this
        }
        _mouseDown(e) {
            this.mouseDownEvent = e, document.addEventListener("mousemove", this._mouseMove, !0), document.addEventListener("mouseup", this._mouseUp, !0), l && (this.el.addEventListener("touchmove", g), this.el.addEventListener("touchend", u)), e.stopPropagation(), e.preventDefault()
        }
        _mouseMove(e) {
        ...
        _mouseUp(e) {
            this.moving && this._triggerEvent("stop", e), document.removeEventListener("mousemove", this._mouseMove, !0), document.removeEventListener("mouseup", this._mouseUp, !0), l && (this.el.removeEventListener("touchmove", g), this.el.removeEventListener("touchend", u)), delete this.moving, delete this.mouseDownEvent, e.stopPropagation(), e.preventDefault()
        }
        _triggerEvent(e, t) {
    ...
    class y extends f {
        ...
        _setupHandlers() {
            ...
            return "all" === e && (e = "n,e,s,w,se,sw,ne,nw"), this.handlers = e.split(",").map((e => e.trim())).map((e => new v(this.el, e, {
                start: e => {
                    this._resizeStart(e)
                },
                stop: e => {
        ...
        _resizeStart(e) {
            this.originalRect = this.el.getBoundingClientRect(), this.scrollEl = i.getScrollElement(this.el), this.scrollY = this.scrollEl.scrollTop, this.scrolled = 0, this.startEvent = e, this._setupHelper(), this._applyChange();
            const t = i.initEvent(e, {
                type: "resizestart",
                target: this.el
            });
        ...
        _setupHelper() {
            return this.elOriginStyleVal = y._originStyleProp.map((e => this.el.style[e])), this.parentOriginStylePosition = this.el.parentElement.style.position, window.getComputedStyle(this.el.parentElement).position.match(/static/) && (this.el.parentElement.style.position = "relative"), this.el.style.position = "absolute", this.el.style.opacity = "0.8", this
        }
        _cleanHelper() {
    ...
    class b extends f {
        ...
        enable() {
            !1 !== this.disabled && (super.enable(), this.dragEl.addEventListener("mousedown", this._mouseDown), l && (this.dragEl.addEventListener("touchstart", p), this.dragEl.addEventListener("pointerdown", c)), this.el.classList.remove("ui-draggable-disabled"))
        }
        disable(e = !1) {
            !0 !== this.disabled && (super.disable(), this.dragEl.removeEventListener("mousedown", this._mouseDown), l && (this.dragEl.removeEventListener("touchstart", p), this.dragEl.removeEventListener("pointerdown", c)), e || this.el.classList.add("ui-draggable-disabled"))
        }
        destroy() {
        ...
        _mouseDown(e) {
            if (!r.mouseHandled) return 0 !== e.button || e.target.closest('input,textarea,button,select,option,[contenteditable="true"],.ui-resizable-handle') || this.option.cancel && e.target.closest(this.option.cancel) || (this.mouseDownEvent = e, delete this.dragging, delete r.dragElement, delete r.dropElement, document.addEventListener("mousemove", this._mouseMove, !0), document.addEventListener("mouseup", this._mouseUp, !0), l && (this.dragEl.addEventListener("touchmove", g), this.dragEl.addEventListener("touchend", u)), e.preventDefault(), document.activeElement && document.activeElement.blur(), r.mouseHandled = !0), !0
        }
        _callDrag(e) {
        ...
        _mouseMove(e) {
            ...
            if (this.dragging)
                ...
                t ? r.dropElement = t.el.ddElement.ddDroppable : delete r.dropElement, this.helper = this._createHelper(e), this._setupHelperContainmentStyle(), this.dragOffset = this._getDragOffset(e, this.el, this.helperContainment);
                const s = i.initEvent(e, {
                    target: this.el,
                    type: "dragstart"
                });
        ...
        _mouseUp(e) {
            if (document.removeEventListener("mousemove", this._mouseMove, !0), document.removeEventListener("mouseup", this._mouseUp, !0), l && (this.dragEl.removeEventListener("touchmove", g, !0), this.dragEl.removeEventListener("touchend", u, !0)), this.dragging) {
                delete this.dragging, r.dropElement?.el === this.el.parentElement && delete r.dropElement, this.helperContainment.style.position = this.parentOriginStylePosition || null, this.helper === this.el ? this._removeHelperStyle() : this.helper.remove();
                const t = i.initEvent(e, {
                    target: this.el,
                    type: "dragstop"
                });
                this.option.stop && this.option.stop(t), this.triggerEvent("dragstop", t), r.dropElement && r.dropElement.drop(e)
            }
        ...
        _createHelper(e) {
            let t = this.el;
            return "function" == typeof this.option.helper ? t = this.option.helper(e) : "clone" === this.option.helper && (t = i.cloneNode(this.el)), document.body.contains(t) || i.appendTo(t, "parent" === this.option.appendTo ? this.el.parentElement : this.option.appendTo), t === this.el && (this.dragElementOriginStyle = b.originStyleProp.map((e => this.el.style[e]))), t
        }
        _setupHelperStyle(e) {
        ...
        _removeHelperStyle() {
            ...
            if (!e?._isAboutToRemove && this.dragElementOriginStyle) {
                ...
                e.style.transition = this.dragElementOriginStyle.transition = "none", b.originStyleProp.forEach((t => e.style[t] = this.dragElementOriginStyle[t] || null)), setTimeout((() => e.style.transition = t), 50)
            }
    ...
    b.originStyleProp = ["transition", "pointerEvents", "position", "left", "top", "minWidth", "willChange"];
    class w extends f {
        constructor(e, t = {}) {
        ...
        enable() {
            !1 !== this.disabled && (super.enable(), this.el.classList.add("ui-droppable"), this.el.classList.remove("ui-droppable-disabled"), this.el.addEventListener("mouseenter", this._mouseEnter), this.el.addEventListener("mouseleave", this._mouseLeave), l && (this.el.addEventListener("pointerenter", m), this.el.addEventListener("pointerleave", _)))
        }
        disable(e = !1) {
            !0 !== this.disabled && (super.disable(), this.el.classList.remove("ui-droppable"), e || this.el.classList.add("ui-droppable-disabled"), this.el.removeEventListener("mouseenter", this._mouseEnter), this.el.removeEventListener("mouseleave", this._mouseLeave), l && (this.el.removeEventListener("pointerenter", m), this.el.removeEventListener("pointerleave", _)))
        }
        destroy() {
        ...
        _mouseEnter(e) {
            ...
            e.preventDefault(), e.stopPropagation(), r.dropElement && r.dropElement !== this && r.dropElement._mouseLeave(e), r.dropElement = this;
            const t = i.initEvent(e, {
                target: this.el,
                type: "dropover"
            });
        ...
        _mouseLeave(e) {
            ...
            if (this.option.out && this.option.out(t, this._ui(r.dragElement)), this.triggerEvent("dropout", t), r.dropElement === this) {
                let t;
    ...
    class E {
        ...
        setupDraggable(e) {
            return this.ddDraggable ? this.ddDraggable.updateOption(e) : this.ddDraggable = new b(this.el, e), this
        }
        cleanDraggable() {
        ...
        setupDroppable(e) {
            return this.ddDroppable ? this.ddDroppable.updateOption(e) : this.ddDroppable = new w(this.el, e), this
        }
        cleanDroppable() {
    ...
    const x = new class {
        ...
        on(e, t, i) {
            return this._getDDElements(e).forEach((e => e.on(t, (e => {
                i(e, r.dragElement ? r.dragElement.el : e.target, r.dragElement ? r.dragElement.helper : null)
            })))), this
        }
        off(e, t) {
    ...
    class R {
        static init(e = {}, t = ".grid-stack") {
            ...
            return s ? (s.gridstack || (s.gridstack = new R(s, i.cloneDeep(e))), s.gridstack) : ("string" == typeof t ? console.error('GridStack.initAll() no grid was found with selector "' + t + '" - element missing or wrong selector ?\nNote: ".grid-stack" is required for proper CSS styling and drag/drop, and is the default selector.') : console.error("GridStack.init() no grid element was passed."), null)
        }
        static initAll(e = {}, t = ".grid-stack") {
            let s = [];
            return R.getGridElements(t).forEach((t => {
                t.gridstack || (t.gridstack = new R(t, i.cloneDeep(e))), s.push(t.gridstack)
            })), 0 === s.length && console.error('GridStack.initAll() no grid was found with selector "' + t + '" - element missing or wrong selector ?\nNote: ".grid-stack" is required for proper CSS styling and drag/drop, and is the default selector.'), s
        }
        static addGrid(e, t = {}) {
            if (!e) return null;
            let i = e;
            if (i.gridstack) {
                ...
                return t && (e.opts = {
                    ...e.opts,
                    ...t
                }), void 0 !== t.children && e.load(t.children), e
            }
        ...
        get placeholder() {
            if (!this._placeholder) {
                ...
                e.className = "placeholder-content", this.opts.placeholderText && (e.innerHTML = this.opts.placeholderText), this._placeholder = document.createElement("div"), this._placeholder.classList.add(this.opts.placeholderClass, o.itemClass, this.opts.itemClass), this.placeholder.appendChild(e)
            }
        ...
        constructor(e, t = {}) {
            ...
            }), this.opts.auto && (this.batchUpdate(), this.getGridItems().forEach((e => this._prepareElement(e))), this.batchUpdate(!1)), this.opts.children) {
                let e = this.opts.children;
                delete this.opts.children, e.length && this.load(e)
            }
            this.setAnimation(this.opts.animate), this._updateStyles(), this.el.classList.add("gs-" + this.opts.column), this.opts.subGridDynamic && !r.pauseDrag && (r.pauseDrag = !0), void 0 !== this.opts.draggable?.pause && (r.pauseDrag = this.opts.draggable.pause), this._setupRemoveDrop(), this._setupAcceptWidget(), this._updateWindowResizeEvent()
        }
        addWidget(e, t) {
            let s, o;
            if ("string" == typeof e) {
            ...
            } else if (0 === arguments.length || 1 === arguments.length && (void 0 !== (n = e).el || void 0 !== n.x || void 0 !== n.y || void 0 !== n.w || void 0 !== n.h || void 0 !== n.content))
                if (o = t = e, o?.el) s = o.el;
                else if (R.addRemoveCB) s = R.addRemoveCB(this.el, t, !0, !1);
                else {
                    let e = t?.content || "",
                        i = document.implementation.createHTMLDocument("");
                    i.body.innerHTML = `<div class="grid-stack-item ${this.opts.itemClass || ""}"><div class="grid-stack-item-content">${e}</div></div>`, s = i.body.children[0]
                } else s = e;
            var n;
            if (!s) return;
            if (o = s.gridstackNode, o && s.parentElement === this.el && this.engine.nodes.find((e => e._id === o._id))) return s;
            let r = this._readAttr(s);
            return t = i.cloneDeep(t) || {}, i.defaults(t, r), o = this.engine.prepareNode(t), this._writeAttr(s, t), this._insertNotAppend ? this.el.prepend(s) : this.el.appendChild(s), this.makeWidget(s, t), s
        }
        makeSubGrid(e, t, s, o = !0) {
            let n, r = e.gridstackNode;
            ...
            t = i.cloneDeep({
                ...
                children: void 0,
                ...t || r.subGridOpts
            }), r.subGridOpts = t, "auto" === t.column && (l = !0, t.column = Math.max(r.w || 1, s?.w || 1), t.disableOneColumnMode = !0);
            let a, d, p = r.el.querySelector(".grid-stack-item-content");
            if (o) {
                if (this._removeDD(r.el), d = {
                    ...r,
                    x: 0,
                    y: 0
                }, i.removeInternalForSave(d), delete d.subGridOpts, r.content && (d.content = r.content, delete r.content), R.addRemoveCB) a = R.addRemoveCB(this.el, d, !0, !1);
                else {
                    let e = document.implementation.createHTMLDocument("");
                    e.body.innerHTML = '<div class="grid-stack-item"></div>', a = e.body.children[0], a.appendChild(p), e.body.innerHTML = '<div class="grid-stack-item-content"></div>', p = e.body.children[0], r.el.appendChild(p)
                }
            ...
            if (s) {
                let e = l ? t.column : r.w,
                    i = r.h + s.h,
                    o = r.el.style;
                o.transition = "none", this.update(r.el, {
                    w: e,
                    h: i
                }), setTimeout((() => o.transition = null))
            }
            let g = r.subGrid = R.addGrid(p, t);
            return s?._moving && (g._isTemp = !0), l && (g._autoColumn = !0), o && g.addWidget(a, d), s && (s._moving ? window.setTimeout((() => i.simulateMouseEvent(s._event, "mouseenter", g.el)), 0) : g.addWidget(r.el, r)), g
        }
        removeAsSubGrid(e) {
            let t = this.parentGridItem?.grid;
            t && (t.batchUpdate(), t.removeWidget(this.parentGridItem.el, !0, !0), this.engine.nodes.forEach((e => {
                e.x += this.parentGridItem.x, e.y += this.parentGridItem.y, t.addWidget(e.el, e)
            })), t.batchUpdate(!1), this.parentGridItem && delete this.parentGridItem.subGrid, delete this.parentGridItem, e && window.setTimeout((() => i.simulateMouseEvent(e._event, "mouseenter", t.el)), 0))
        }
        save(e = !0, t = !1, s = R.saveCB) {
            ...
            if (n.forEach((i => {
                if (e && i.el && !i.subGrid && !s) {
                    ...
                    i.content = e ? e.innerHTML : void 0, i.content || delete i.content
                ...
                return delete e._alwaysShowResizeHandle, void 0 !== t ? e.alwaysShowResizeHandle = t : delete e.alwaysShowResizeHandle, i.removeInternalAndSame(e, o), e.children = n, e
            }
            return n
        }
        load(e, t = R.addRemoveCB || !0) {
            ...
            return this.batchUpdate(), t && [...this.engine.nodes].forEach((e => {
                i.find((t => e.id === t.id)) || (R.addRemoveCB && R.addRemoveCB(this.el, e, !1, !1), o.push(e), this.removeWidget(e.el, !0, !1))
            })), i.forEach((e => {
                let i = void 0 !== e.id ? this.engine.nodes.find((t => t.id === e.id)) : void 0;
                if (i) {
                    if (this.update(i.el, e), e.subGridOpts?.children) {
                        let t = i.el.querySelector(".grid-stack");
                        t && t.gridstack && (t.gridstack.load(e.subGridOpts.children), this._insertNotAppend = !0)
                    }
                } else t && this.addWidget(e)
            })), this.engine.removedNodes = o, this.batchUpdate(!1), delete this._ignoreLayoutsNodeChange, delete this._insertNotAppend, s ? R.addRemoveCB = s : delete R.addRemoveCB, this
        }
        batchUpdate(e = !0) {
        ...
        getCellHeight(e = !1) {
            ...
            return s ? Math.round(this.el.getBoundingClientRect().height / s) : this.opts.cellHeight
        }
        cellHeight(e, t = !0) {
            ...
            return this.opts.cellHeightUnit === s.unit && this.opts.cellHeight === s.h || (this.opts.cellHeightUnit = s.unit, this.opts.cellHeight = s.h, t && this._updateStyles(!0)), this
        }
        cellWidth() {
        ...
        column(e, t = "moveScale") {
            ...
            return 1 === e ? this._prevColumn = s : delete this._prevColumn, this.el.classList.remove("gs-" + s), this.el.classList.add("gs-" + e), this.opts.column = this.engine.column = e, 1 === e && this.opts.oneColumnModeDomSort && (i = [], this.getGridItems().forEach((e => {
                e.gridstackNode && i.push(e.gridstackNode)
            })), i.length || (i = void 0)), this.engine.columnChanged(s, e, i, t), this._isAutoCellHeight && this.cellHeight(), this._ignoreLayoutsNodeChange = !0, this._triggerChangeEvent(), delete this._ignoreLayoutsNodeChange, this
        }
        getColumn() {
        ...
        makeWidget(e, t) {
            ...
            return s.subGridOpts && this.makeSubGrid(i, s.subGridOpts, void 0, !1), this._prevColumn && 1 === this.opts.column && (this._ignoreLayoutsNodeChange = !0), this._triggerAddEvent(), this._triggerChangeEvent(), delete this._ignoreLayoutsNodeChange, i
        }
        on(e, t) {
        ...
        removeWidget(e, t = !0, i = !0) {
            return R.getElements(e).forEach((e => {
                if (e.parentElement && e.parentElement !== this.el) return;
                let s = e.gridstackNode;
                s || (s = this.engine.nodes.find((t => e === t.el))), s && (R.addRemoveCB && R.addRemoveCB(this.el, s, !1, !1), delete e.gridstackNode, this._removeDD(e), this.engine.removeNode(s, t, i), t && e.parentElement && e.remove())
        ...
        setStatic(e, t = !0, i = !0) {
            return !!this.opts.staticGrid === e || (e ? this.opts.staticGrid = !0 : delete this.opts.staticGrid, this._setupRemoveDrop(), this._setupAcceptWidget(), this.engine.nodes.forEach((s => {
        ...
        update(e, t) {
            ...
            return R.getElements(e).forEach((e => {
                ...
                let n, r = ["x", "y", "w", "h"];
                if (r.some((e => void 0 !== o[e] && o[e] !== s[e])) && (n = {}, r.forEach((e => {
                    n[e] = void 0 !== o[e] ? o[e] : s[e], delete o[e]
                }))), !n && (o.minW || o.minH || o.maxW || o.maxH) && (n = {}), o.content) {
                    let t = e.querySelector(".grid-stack-item-content");
                    t && t.innerHTML !== o.content && (t.innerHTML = o.content), delete o.content
                }
                let l = !1,
                    h = !1;
                for (const e in o) "_" !== e[0] && s[e] !== o[e] && (s[e] = o[e], l = !0, h = h || !this.opts.staticGrid && ("noResize" === e || "noMove" === e || "locked" === e));
                i.sanitizeMinMax(s), n && (this.engine.cleanNodes().beginUpdate(s).moveNode(s, n), this._updateContainerHeight(), this._triggerChangeEvent(), this.engine.endUpdate()), l && this._writeAttr(e, s), h && this._prepareDragDropByNode(s)
            })), this
        }
        margin(e) {
        ...
        _triggerAddEvent() {
            return this.engine.batchMode || this.engine.addedNodes?.length && (this._ignoreLayoutsNodeChange || this.engine.layoutsNodesChange(this.engine.addedNodes), this.engine.addedNodes.forEach((e => {
                delete e._dirty
            })), this._triggerEvent("added", this.engine.addedNodes), this.engine.addedNodes = []), this
        }
        _triggerRemoveEvent() {
            return this.engine.batchMode || this.engine.removedNodes?.length && (this._triggerEvent("removed", this.engine.removedNodes), this.engine.removedNodes = []), this
        }
        _triggerEvent(e, t) {
        ...
        _removeStylesheet() {
            return this._styles && (i.removeStylesheet(this._styleSheetClass), delete this._styles), this
        }
        _updateStyles(e = !1, t) {
            ...
            if (!this._styles) {
                ...
                if (this._styles = i.createStylesheet(this._styleSheetClass, e, {
                    nonce: this.opts.nonce
                }), !this._styles) return this;
                this._styles._max = 0, i.addCSSRule(this._styles, n, `height: ${s}${o}`);
                ...
                i.addCSSRule(this._styles, a, `top: ${t}; right: ${l}; bottom: ${r}; left: ${h};`), i.addCSSRule(this._styles, d, `top: ${t}; right: ${l}; bottom: ${r}; left: ${h};`), i.addCSSRule(this._styles, `${n} > .ui-resizable-ne`, `right: ${l}`), i.addCSSRule(this._styles, `${n} > .ui-resizable-e`, `right: ${l}`), i.addCSSRule(this._styles, `${n} > .ui-resizable-se`, `right: ${l}; bottom: ${r}`), i.addCSSRule(this._styles, `${n} > .ui-resizable-nw`, `left: ${h}`), i.addCSSRule(this._styles, `${n} > .ui-resizable-w`, `left: ${h}`), i.addCSSRule(this._styles, `${n} > .ui-resizable-sw`, `left: ${h}; bottom: ${r}`)
            }
            if ((t = t || this._styles._max) > this._styles._max) {
                let e = e => s * e + o;
                for (let s = this._styles._max + 1; s <= t; s++) i.addCSSRule(this._styles, `${n}[gs-y="${s}"]`, `top: ${e(s)}`), i.addCSSRule(this._styles, `${n}[gs-h="${s + 1}"]`, `height: ${e(s + 1)}`);
                this._styles._max = t
            }
            return this
        }
        ...
        _prepareElement(e, t = !1, s) {
            e.classList.add(this.opts.itemClass), s = s || this._readAttr(e), e.gridstackNode = s, s.el = e, s.grid = this;
            let o = {
                ...s
            };
            return s = this.engine.addNode(s, t), i.same(s, o) || this._writeAttr(e, s), this._prepareDragDropByNode(s), this
        }
        _writePosAttr(e, t) {
            return void 0 !== t.x && null !== t.x && e.setAttribute("gs-x", String(t.x)), void 0 !== t.y && null !== t.y && e.setAttribute("gs-y", String(t.y)), t.w > 1 ? e.setAttribute("gs-w", String(t.w)) : e.removeAttribute("gs-w"), t.h > 1 ? e.setAttribute("gs-h", String(t.h)) : e.removeAttribute("gs-h"), this
        }
        _writeAttr(e, t) {
            if (!t) return this;
        ...
        _readAttr(e, t = !0) {
            let s = {};
            s.x = i.toNumber(e.getAttribute("gs-x")), s.y = i.toNumber(e.getAttribute("gs-y")), s.w = i.toNumber(e.getAttribute("gs-w")), s.h = i.toNumber(e.getAttribute("gs-h")), s.autoPosition = i.toBool(e.getAttribute("gs-auto-position")), s.noResize = i.toBool(e.getAttribute("gs-no-resize")), s.noMove = i.toBool(e.getAttribute("gs-no-move")), s.locked = i.toBool(e.getAttribute("gs-locked")), s.id = e.getAttribute("gs-id"), s.maxW = i.toNumber(e.getAttribute("gs-max-w")), s.minW = i.toNumber(e.getAttribute("gs-min-w")), s.maxH = i.toNumber(e.getAttribute("gs-max-h")), s.minH = i.toNumber(e.getAttribute("gs-min-h")), t && (1 === s.w && e.removeAttribute("gs-w"), 1 === s.h && e.removeAttribute("gs-h"), s.maxW && e.removeAttribute("gs-max-w"), s.minW && e.removeAttribute("gs-min-w"), s.maxH && e.removeAttribute("gs-max-h"), s.minH && e.removeAttribute("gs-min-h"));
            for (const e in s) {
        ...
        onParentResize() {
            ...
            return this._isAutoCellHeight && (!e && this.opts.cellHeightThrottle ? (this._cellHeightThrottle || (this._cellHeightThrottle = i.throttle((() => this.cellHeight()), this.opts.cellHeightThrottle)), this._cellHeightThrottle()) : this.cellHeight()), this.engine.nodes.forEach((e => {
        ...
        _initMargin() {
            let e, t = 0,
                s = [];
            return "string" == typeof this.opts.margin && (s = this.opts.margin.split(" ")), 2 === s.length ? (this.opts.marginTop = this.opts.marginBottom = s[0], this.opts.marginLeft = this.opts.marginRight = s[1]) : 4 === s.length ? (this.opts.marginTop = s[0], this.opts.marginRight = s[1], this.opts.marginBottom = s[2], this.opts.marginLeft = s[3]) : (e = i.parseHeight(this.opts.margin), this.opts.marginUnit = e.unit, t = this.opts.margin = e.h), void 0 === this.opts.marginTop ? this.opts.marginTop = t : (e = i.parseHeight(this.opts.marginTop), this.opts.marginTop = e.h, delete this.opts.margin), void 0 === this.opts.marginBottom ? this.opts.marginBottom = t : (e = i.parseHeight(this.opts.marginBottom), this.opts.marginBottom = e.h, delete this.opts.margin), void 0 === this.opts.marginRight ? this.opts.marginRight = t : (e = i.parseHeight(this.opts.marginRight), this.opts.marginRight = e.h, delete this.opts.margin), void 0 === this.opts.marginLeft ? this.opts.marginLeft = t : (e = i.parseHeight(this.opts.marginLeft), this.opts.marginLeft = e.h, delete this.opts.margin), this.opts.marginUnit = e.unit, this.opts.marginTop === this.opts.marginBottom && this.opts.marginLeft === this.opts.marginRight && this.opts.marginTop === this.opts.marginRight && (this.opts.margin = this.opts.marginTop), this
        }
        static getDD() {
            return x
        }
        static setupDragIn(e, t, s = document) {
            void 0 !== t?.pause && (r.pauseDrag = t.pause), t = {
                ...n,
                ...t || {}
            };
        ...
        movable(e, t) {
            return this.opts.staticGrid || R.getElements(e).forEach((e => {
        ...
        enableMove(e, t = !0) {
            return this.opts.staticGrid || (e ? delete this.opts.disableDrag : this.opts.disableDrag = !0, this.engine.nodes.forEach((i => {
                this._prepareDragDropByNode(i), i.subGrid && t && i.subGrid.enableMove(e, t)
            }))), this
        }
        enableResize(e, t = !0) {
            return this.opts.staticGrid || (e ? delete this.opts.disableResize : this.opts.disableResize = !0, this.engine.nodes.forEach((i => {
                this._prepareDragDropByNode(i), i.subGrid && t && i.subGrid.enableResize(e, t)
            }))), this
        }
        _removeDD(e) {
            return x.draggable(e, "destroy").resizable(e, "destroy"), e.gridstackNode && delete e.gridstackNode._initDD, delete e.ddElement, this
        }
        _setupAcceptWidget() {
            if (this.opts.staticGrid || !this.opts.acceptWidgets && !this.opts.removable) return x.droppable(this.el, "destroy"), this;
            let e, t, s = (s, o, n) => {
                ...
                if (r._temporaryRemoved) {
                    if (r.x = Math.max(0, Math.round(a / t)), r.y = Math.max(0, Math.round(h / e)), delete r.autoPosition, this.engine.nodeBoundFix(r), !this.engine.willItFit(r)) {
                        if (r.autoPosition = !0, !this.engine.willItFit(r)) return void x.off(o, "drag");
                        r._willFitPos && (i.copyPos(r, r._willFitPos), delete r._willFitPos)
                    }
            ...
            return x.droppable(this.el, {
                ...
                r?.grid && r.grid !== this && !r._temporaryRemoved && r.grid._leave(o, n), t = this.cellWidth(), e = this.getCellHeight(!0), r || (r = this._readAttr(o, !1)), r.grid || (r._isExternal = !0, o.gridstackNode = r), n = n || o;
                let l = r.w || Math.round(n.offsetWidth / t) || 1,
                    h = r.h || Math.round(n.offsetHeight / e) || 1;
                return r.grid && r.grid !== this ? (o._gridstackNodeOrig || (o._gridstackNodeOrig = r), o.gridstackNode = r = {
                    ...r,
                    w: l,
                    h,
                    grid: this
                }, this.engine.cleanupNode(r).nodeBoundFix(r), r._initDD = r._isExternal = r._temporaryRemoved = !0) : (r.w = l, r.h = h, r._temporaryRemoved = !0), this._itemRemoving(r.el, !1), x.on(o, "drag", s), s(i, o, n), !1
                ...
                if (delete t._gridstackNodeOrig, r && l?.grid && l.grid !== this) {
                    let e = l.grid;
                    e.engine.removedNodes.push(l), e._triggerRemoveEvent()._triggerChangeEvent(), e.parentGridItem && !e.engine.nodes.length && e.opts.subGridDynamic && e.removeAsSubGrid()
                }
                if (!n) return !1;
                if (r && (this.engine.cleanupNode(n), n.grid = this), x.off(t, "drag"), s !== t ? (s.remove(), t.gridstackNode = l, r && (t = t.cloneNode(!0))) : (t.remove(), this._removeDD(t)), !r) return !1;
                t.gridstackNode = n, n.el = t;
                let h = n.subGrid?.el?.gridstack;
                return i.copyPos(n, this._readAttr(this.placeholder)), i.removePositioningStyles(t), this._writeAttr(t, n), t.classList.add(o.itemClass, this.opts.itemClass), this.el.appendChild(t), h && (h.parentGridItem = n, h.opts.styleInHead || h._updateStyles(!0)), this._updateContainerHeight(), this.engine.addedNodes.push(n), this._triggerAddEvent(), this._triggerChangeEvent(), this.engine.endUpdate(), this._gsEventHandler.dropped && this._gsEventHandler.dropped({
                    ...e,
                    type: "dropped"
                }, l && l.grid ? l : void 0, n), window.setTimeout((() => {
        ...
        _setupRemoveDrop() {
            if (!this.opts.staticGrid && "string" == typeof this.opts.removable) {
                ...
                if (!e) return this;
                x.isDroppable(e) || x.droppable(e, this.opts.removableOptions).on(e, "dropover", ((e, t) => this._itemRemoving(t, !0))).on(e, "dropout", ((e, t) => this._itemRemoving(t, !1)))
            }
            return this
        }
        _prepareDragDropByNode(e) {
            ...
            if (this.opts.staticGrid || s && o) return e._initDD && (this._removeDD(t), delete e._initDD), t.classList.add("ui-draggable-disabled", "ui-resizable-disabled"), this;
            if (!e._initDD) {
                let s, o, n = (i, n) => {
                    this._gsEventHandler[i.type] && this._gsEventHandler[i.type](i, i.target), s = this.cellWidth(), o = this.getCellHeight(!0), this._onStartMoving(t, i, n, e, s, o)
                },
                    r = (i, n) => {
                    ...
                    l = s => {
                        ...
                        if (o.gridstackNode && o.gridstackNode.grid === this) {
                            if (e.el = o, e._isAboutToRemove) {
                                ...
                                i._gsEventHandler[s.type] && i._gsEventHandler[s.type](s, o), this._removeDD(t), i.engine.removedNodes.push(e), i._triggerRemoveEvent(), delete t.gridstackNode, delete e.el, t.remove()
                            } else i.removePositioningStyles(o), e._temporaryRemoved ? (i.copyPos(e, e._orig), this._writePosAttr(o, e), this.engine.addNode(e)) : this._writePosAttr(o, e), this._gsEventHandler[s.type] && this._gsEventHandler[s.type](s, o);
        ...
        _dragOrResize(e, t, s, o, n, r) {
            let l, h = {
                ...
                u = Math.round(.1 * r),
                c = Math.round(.1 * n);
            if (a = Math.min(a, c), d = Math.min(d, c), p = Math.min(p, u), g = Math.min(g, u), "drag" === t.type) {
                if (o._temporaryRemoved) return;
                let t = s.position.top - o._prevYPix;
                o._prevYPix = s.position.top, !1 !== this.opts.draggable.scroll && i.updateScrollPosition(e, s.position, t);
                let l = s.position.left + (s.position.left > o._lastUiPosition.left ? -d : a),
                    u = s.position.top + (s.position.top > o._lastUiPosition.top ? -g : p);
                ...
                if (this._extraDragRow !== c && this._updateContainerHeight(), o.x === h.x && o.y === h.y) return
            } else if ("resize" === t.type) {
                if (h.x < 0) return;
                if (i.updateScrollResize(t, e, r), h.w = Math.round((s.size.width - a) / n), h.h = Math.round((s.size.height - p) / r), o.w === h.w && o.h === h.h) return;
            ...
            if (this.engine.moveNodeCheck(o, {
                ...h,
                cellWidth: n,
                cellHeight: r,
                rect: m,
                ...
                o._lastUiPosition = s.position, this.engine.cacheRects(n, r, p, d, g, a), delete o._skipDown, l && o.subGrid && o.subGrid.onParentResize(), this._extraDragRow = 0, this._updateContainerHeight();
                let e = t.target;
                this._writePosAttr(e, o), this._gsEventHandler[t.type] && this._gsEventHandler[t.type](t, e)
            }
        }
        _leave(e, t) {
            let i = e.gridstackNode;
            i && (x.off(e, "drag"), i._temporaryRemoved || (i._temporaryRemoved = !0, this.engine.removeNode(i), i.el = i._isExternal && t ? t : e, !0 === this.opts.removable && this._itemRemoving(e, !0), e._gridstackNodeOrig ? (e.gridstackNode = e._gridstackNodeOrig, delete e._gridstackNodeOrig) : i._isExternal && (delete i.el, delete e.gridstackNode, this.engine.restoreInitial())))
        }
        commit() {
