...
@Component({
  selector: 'app-customer-leadger',
  templateUrl: './customer-leadger.component.html',
  styleUrls: ['./customer-leadger.component.css'],
})
export class CustomerLeadgerComponent {
  @ViewChild('customerLedgerLists', { static: false })
  customerLedgerLists!: ElementRef;
  ...
  onClickChk(event: any) {
    const tableElement = this.customerLedgerLists.nativeElement;
