...
@Component({
  selector: 'app-term-and-conditions-approval',
  templateUrl: './term-and-conditions-approval.component.html',
  styleUrls: ['./term-and-conditions-approval.component.css']
})
export class TermAndConditionsApprovalComponent {
  ...
  onClickSave() {
    ...
    try {
      ...
      this.apiService
        .saveData('Approval/UpdatePartyTermCondition', voucher)
        .subscribe((result) => {
  ...
  PrintTermsConditions(CodeValue: any) { 
