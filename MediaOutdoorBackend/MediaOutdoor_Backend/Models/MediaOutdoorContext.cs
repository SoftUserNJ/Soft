...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=89.40.160.12;Database=MediaOutdoor;user id=sa;password=Hostsqlpalace@9876;  Integrated security=False; TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TblScreen>(entity =>
        {
            ...
            entity.Property(e => e.Xposition1)
                .HasMaxLength(10)
                .HasColumnName("XPosition1");
            entity.Property(e => e.Yposition)
                .HasMaxLength(10)
                .HasColumnName("YPosition");
            entity.Property(e => e.Yposition1)
                .HasMaxLength(10)
                .HasColumnName("YPosition1");
        });
        ...
        modelBuilder.Entity<TblSetting>(entity =>
        {
            ...
            entity.Property(e => e.ShowCpm).HasColumnName("ShowCPM");
        });
